<template>
    <v-row v-ripple class="cursor-pointer" @click="$router.push(localePath('/activities/events/' + getSlugFromPath(item._path)))">
        <v-col align-self="center" cols="2" class="dense">
        ...
        <v-col align-self="center" cols="4" class="dense">
